...
class AwscliV2(PythonPackage):
    ...
    with default_args(type=("build", "run")):
        ...
        # py-urllib3 restrictions based on botocore (via Gemini chat)
        # For Python 3.10 and newer, support urllib3 v1 and v2
        # (excluding 2.2.0 which breaks botocore)
        depends_on("py-urllib3@1.25.4:2.1,2.2.1:2.99", when="^python@3.10:")
