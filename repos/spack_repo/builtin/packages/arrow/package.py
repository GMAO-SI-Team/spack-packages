...
class Arrow(CMakePackage, CudaPackage):
    ...
    variant("csv", default=False, description="Build support for reading of CSV")
    variant(
    ...
    variant(
        "mimalloc",
        default=True,
        description="Build the Arrow mimalloc-based allocator (vendored; downloads source at build time)",
    )
